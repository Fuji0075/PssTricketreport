...
- **หน้าวิเคราะห์ปัญหาซ้ำ**: ใส่คีย์เวิร์ด (คั่นด้วย comma เช่น "กระดาษติด, ไม้กั้นไม่เปิด") จะนับให้ว่าตรงกับ ticket กี่เคส แยกแก้ไขแล้ว/ยังแก้ไม่ได้ ค้นทั้งหัวข้อ/รายละเอียด/บันทึกในช่องคอมเมนต์ มีให้ดู 2 มุม:
  - **สรุปตามสาขา**: รูปแบบ "ชื่อสาขา = คีย์เวิร์ด = จำนวนครั้ง" พร้อมติดป้าย "เป็นซ้ำบ่อย" ถ้าคีย์เวิร์ดนั้นเกิดที่สาขานั้นตั้งแต่ 2 ครั้งขึ้นไป เห็นชัดว่าสาขาไหนมีปัญหาเดิมซ้ำๆ
  - **สรุปตามคีย์เวิร์ด**: รวมทุกสาขา พร้อม **วิธีแก้ที่พบบ่อยที่สุด** (ดึงจากช่องรายละเอียดและบันทึกในคอมเมนต์ จัดอันดับตามความถี่ที่พบ) เผื่อกรณีปัญหาเดิมส่วนใหญ่แก้ด้วยวิธีเดียวกัน
