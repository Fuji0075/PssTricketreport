...
- หน้าสรุปรายวัน: ticket ที่สร้างใหม่, ticket ที่ปิดแล้ว, บันทึกงานที่ทำ, และภาพรวมสถานะทั้งหมด
  - มีกล่อง **"📋 สรุปสำหรับแจ้งในไลน์"** สร้างข้อความสรุปแบบมีเลขข้อ + รายละเอียดที่ทำ (ดึงจากบันทึกแชทของแต่ละ ticket ที่มีความเคลื่อนไหววันนั้น) พร้อมปุ่มคัดลอกไปวางในกลุ่มไลน์ได้ทันที ไม่ต้องพิมพ์สรุปเองทุกวัน
